...
A signed 64-bit fixed-point number with 20 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-8.796093022208e12` to `8.796093022208e12`

The stored `Int64` value `i` is interpreted as `i / 2^20`. This is equivalent to `Fixed{Int64, 20}` in `FixedPointNumbers.jl`.
