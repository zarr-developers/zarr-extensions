...
A signed 64-bit fixed-point number with 4 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-5.764607523034235e17` to `5.764607523034235e17`

The stored `Int64` value `i` is interpreted as `i / 2^4`. This is equivalent to `Fixed{Int64, 4}` in `FixedPointNumbers.jl`.
