...
A signed 64-bit fixed-point number with 0 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-9.223372036854776e18` to `9.223372036854776e18`

The stored `Int64` value `i` is interpreted as `i / 2^0`. This is equivalent to `Fixed{Int64, 0}` in `FixedPointNumbers.jl`.
