...
A signed 64-bit fixed-point number with 14 fractional bits.
...
- **base_type**: `int64`
- **f**: 14 (number of fractional bits)
- **scaling**: by `2^f`
- **range**: `-5.62949953421312e14` to `5.62949953421312e14`

The stored `Int64` value `i` is interpreted as `i / 2^14`. This is equivalent to `Fixed{Int64, 14}` in `FixedPointNumbers.jl`.
