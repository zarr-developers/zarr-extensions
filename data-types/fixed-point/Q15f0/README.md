...
A signed 16-bit fixed-point number with 0 fractional bits.
...
The stored `Int16` value `i` is interpreted as `i / 2^0`. This is equivalent to `Fixed{Int16, 0}` in `FixedPointNumbers.jl`.
