...
A signed 64-bit fixed-point number with 19 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.7592186044416e13` to `1.7592186044416e13`

The stored `Int64` value `i` is interpreted as `i / 2^19`. This is equivalent to `Fixed{Int64, 19}` in `FixedPointNumbers.jl`.
