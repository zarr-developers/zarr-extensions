...
A signed 64-bit fixed-point number with 3 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.152921504606847e18` to `1.152921504606847e18`

The stored `Int64` value `i` is interpreted as `i / 2^3`. This is equivalent to `Fixed{Int64, 3}` in `FixedPointNumbers.jl`.
