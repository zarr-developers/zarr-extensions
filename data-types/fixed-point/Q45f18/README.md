...
A signed 64-bit fixed-point number with 18 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-3.5184372088832e13` to `3.5184372088832e13`

The stored `Int64` value `i` is interpreted as `i / 2^18`. This is equivalent to `Fixed{Int64, 18}` in `FixedPointNumbers.jl`.
