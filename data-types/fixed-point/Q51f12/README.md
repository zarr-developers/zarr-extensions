...
A signed 64-bit fixed-point number with 12 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-2.251799813685248e15` to `2.251799813685248e15`

The stored `Int64` value `i` is interpreted as `i / 2^12`. This is equivalent to `Fixed{Int64, 12}` in `FixedPointNumbers.jl`.
