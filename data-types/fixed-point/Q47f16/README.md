...
A signed 64-bit fixed-point number with 16 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.40737488355328e14` to `1.40737488355328e14`

The stored `Int64` value `i` is interpreted as `i / 2^16`. This is equivalent to `Fixed{Int64, 16}` in `FixedPointNumbers.jl`.
