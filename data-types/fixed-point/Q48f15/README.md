...
A signed 64-bit fixed-point number with 15 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-2.81474976710656e14` to `2.81474976710656e14`

The stored `Int64` value `i` is interpreted as `i / 2^15`. This is equivalent to `Fixed{Int64, 15}` in `FixedPointNumbers.jl`.
