...
A signed 64-bit fixed-point number with 13 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.125899906842624e15` to `1.125899906842624e15`

The stored `Int64` value `i` is interpreted as `i / 2^13`. This is equivalent to `Fixed{Int64, 13}` in `FixedPointNumbers.jl`.
