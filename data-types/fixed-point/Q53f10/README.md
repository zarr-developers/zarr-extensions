...
A signed 64-bit fixed-point number with 10 fractional bits.
...
- **base_type**: `int64`
- **f**: 10 (number of fractional bits)
- **scaling**: by `2^f`
- **range**: `-9.007199254740992e15` to `9.007199254740992e15`

The stored `Int64` value `i` is interpreted as `i / 2^10`. This is equivalent to `Fixed{Int64, 10}` in `FixedPointNumbers.jl`.
