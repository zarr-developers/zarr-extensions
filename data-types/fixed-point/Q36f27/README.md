...
A signed 64-bit fixed-point number with 27 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-6.8719476736e10` to `6.8719476736e10`

The stored `Int64` value `i` is interpreted as `i / 2^27`. This is equivalent to `Fixed{Int64, 27}` in `FixedPointNumbers.jl`.
