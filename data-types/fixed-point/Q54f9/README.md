...
A signed 64-bit fixed-point number with 9 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.8014398509481984e16` to `1.8014398509481984e16`

The stored `Int64` value `i` is interpreted as `i / 2^9`. This is equivalent to `Fixed{Int64, 9}` in `FixedPointNumbers.jl`.
