...
A signed 64-bit fixed-point number with 29 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-1.7179869184e10` to `1.7179869184e10`

The stored `Int64` value `i` is interpreted as `i / 2^29`. This is equivalent to `Fixed{Int64, 29}` in `FixedPointNumbers.jl`.
