...
A signed 16-bit fixed-point number with 10 fractional bits.
...
The stored `Int16` value `i` is interpreted as `i / 2^10`. This is equivalent to `Fixed{Int16, 10}` in `FixedPointNumbers.jl`.
