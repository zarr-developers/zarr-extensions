...
A signed 64-bit fixed-point number with 28 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-3.4359738368e10` to `3.4359738368e10`

The stored `Int64` value `i` is interpreted as `i / 2^28`. This is equivalent to `Fixed{Int64, 28}` in `FixedPointNumbers.jl`.
