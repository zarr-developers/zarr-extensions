...
A signed 64-bit fixed-point number with 5 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-2.8823037615171174e17` to `2.8823037615171174e17`

The stored `Int64` value `i` is interpreted as `i / 2^5`. This is equivalent to `Fixed{Int64, 5}` in `FixedPointNumbers.jl`.
