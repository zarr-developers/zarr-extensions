...
A signed 64-bit fixed-point number with 25 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-2.74877906944e11` to `2.74877906944e11`

The stored `Int64` value `i` is interpreted as `i / 2^25`. This is equivalent to `Fixed{Int64, 25}` in `FixedPointNumbers.jl`.
