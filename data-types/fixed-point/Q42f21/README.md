...
A signed 64-bit fixed-point number with 21 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-4.398046511104e12` to `4.398046511104e12`

The stored `Int64` value `i` is interpreted as `i / 2^21`. This is equivalent to `Fixed{Int64, 21}` in `FixedPointNumbers.jl`.
