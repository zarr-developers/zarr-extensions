...
A signed 16-bit fixed-point number with 9 fractional bits.
...
The stored `Int16` value `i` is interpreted as `i / 2^9`. This is equivalent to `Fixed{Int16, 9}` in `FixedPointNumbers.jl`.
