...
A signed 64-bit fixed-point number with 17 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-7.0368744177664e13` to `7.0368744177664e13`

The stored `Int64` value `i` is interpreted as `i / 2^17`. This is equivalent to `Fixed{Int64, 17}` in `FixedPointNumbers.jl`.
