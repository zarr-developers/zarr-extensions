...
A signed 16-bit fixed-point number with 7 fractional bits.
...
The stored `Int16` value `i` is interpreted as `i / 2^7`. This is equivalent to `Fixed{Int16, 7}` in `FixedPointNumbers.jl`.
