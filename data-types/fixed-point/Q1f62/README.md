...
A signed 64-bit fixed-point number with 62 fractional bits.
...
The stored `Int64` value `i` is interpreted as `i / 2^62`. This is equivalent to `Fixed{Int64, 62}` in `FixedPointNumbers.jl`.
