...
A signed 64-bit fixed-point number with 59 fractional bits.
...
The stored `Int64` value `i` is interpreted as `i / 2^59`. This is equivalent to `Fixed{Int64, 59}` in `FixedPointNumbers.jl`.
