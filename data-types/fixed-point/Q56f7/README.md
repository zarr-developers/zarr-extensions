...
A signed 64-bit fixed-point number with 7 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-7.205759403792794e16` to `7.205759403792794e16`

The stored `Int64` value `i` is interpreted as `i / 2^7`. This is equivalent to `Fixed{Int64, 7}` in `FixedPointNumbers.jl`.
