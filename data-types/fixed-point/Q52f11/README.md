...
A signed 64-bit fixed-point number with 11 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-4.503599627370496e15` to `4.503599627370496e15`

The stored `Int64` value `i` is interpreted as `i / 2^11`. This is equivalent to `Fixed{Int64, 11}` in `FixedPointNumbers.jl`.
