...
A signed 64-bit fixed-point number with 24 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-5.49755813888e11` to `5.49755813888e11`

The stored `Int64` value `i` is interpreted as `i / 2^24`. This is equivalent to `Fixed{Int64, 24}` in `FixedPointNumbers.jl`.
