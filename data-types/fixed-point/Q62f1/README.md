...
A signed 64-bit fixed-point number with 1 fractional bit.
...
- **scaling**: by `2^f`
- **range**: `-4.611686018427388e18` to `4.611686018427388e18`

The stored `Int64` value `i` is interpreted as `i / 2^1`. This is equivalent to `Fixed{Int64, 1}` in `FixedPointNumbers.jl`.
