...
A signed 64-bit fixed-point number with 58 fractional bits.
...
The stored `Int64` value `i` is interpreted as `i / 2^58`. This is equivalent to `Fixed{Int64, 58}` in `FixedPointNumbers.jl`.
