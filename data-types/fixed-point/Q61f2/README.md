...
A signed 64-bit fixed-point number with 2 fractional bits.
...
- **scaling**: by `2^f`
- **range**: `-2.305843009213694e18` to `2.305843009213694e18`

The stored `Int64` value `i` is interpreted as `i / 2^2`. This is equivalent to `Fixed{Int64, 2}` in `FixedPointNumbers.jl`.
