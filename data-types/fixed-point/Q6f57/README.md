...
A signed 64-bit fixed-point number with 57 fractional bits.
...
The stored `Int64` value `i` is interpreted as `i / 2^57`. This is equivalent to `Fixed{Int64, 57}` in `FixedPointNumbers.jl`.
